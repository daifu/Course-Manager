 ...
 * Copyright (c) 2009-2011 by UCLACourseManager, Inc. All Rights Reserved.
...
//@interface UCLACourseManagerObject : NSObject
//@end

@interface UCLACourseManagerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UCLACourseManagerObject class]])
		{
			for (NSString *key in [[(UCLACourseManagerObject*)o modules] allKeys])
			{
