...
// in simulator we redefine to format for UCLACourseManager Developer console
...
{\
	NSString * exceptionName = [@"org.uclacoursemanager." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.uclacoursemanager";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIUCLACourseManagerNativeItemNone = -1, 
	UIUCLACourseManagerNativeItemSpinner = -2,
	UIUCLACourseManagerNativeItemProgressBar = -3,
	
	UIUCLACourseManagerNativeItemSlider = -4,
	UIUCLACourseManagerNativeItemSwitch = -5,
	UIUCLACourseManagerNativeItemMultiButton = -6,
	UIUCLACourseManagerNativeItemSegmented = -7,
	
	UIUCLACourseManagerNativeItemTextView = -8,
	UIUCLACourseManagerNativeItemTextField = -9,
	UIUCLACourseManagerNativeItemSearchBar = -10,
	
	UIUCLACourseManagerNativeItemPicker = -11,
	UIUCLACourseManagerNativeItemDatePicker = -12,
	
	UIUCLACourseManagerNativeItemInfoLight = -13,
	UIUCLACourseManagerNativeItemInfoDark = -14,
	
	UIUCLACourseManagerNativeItemDisclosure = -15,
	
	UIUCLACourseManagerNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all UCLACourseManager instances of
