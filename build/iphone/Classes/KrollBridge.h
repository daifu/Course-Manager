...
@interface UCLACourseManagerObject : KrollCoverageObject {
#else
@interface UCLACourseManagerObject : KrollObject {
#endif
@private
...
extern NSString * UCLACourseManager$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	UCLACourseManagerObject *_uclacoursemanager;
	BOOL shutdown;
